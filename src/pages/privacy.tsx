      ...
      <DashboardLayout>
        <ContentLayout>
          ...
          <div className="text-xl flex flex-col gap-4 font-medium opacity-70">
            ...
            <ul>
              <li>
                Visit our website at sqrlplanner.com, or any website of ours
            ...
            <div>
              ...
              information depending on how you interact with Sqrl Planner and
            ...
            <div>
              Want to learn more about what Sqrl Planner does with any
            ...
            <div>
              ...
              providers, social media platforms,&nbsp;and from other third
            ...
            <div>
              ...
              may email us at admin@sqrlplanner.com.
            </div>
